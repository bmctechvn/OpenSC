...
extern sc_card_driver_t* sc_get_openpgp_driver_2(void);
extern sc_card_driver_t* sc_get_openpgp_driver_3(void);
extern sc_card_driver_t* sc_get_openpgp_driver_4(void);
extern sc_card_driver_t* sc_get_openpgp_driver_5(void);
extern sc_card_driver_t* sc_get_openpgp_driver_6(void);
extern sc_card_driver_t* sc_get_openpgp_driver_7(void);
extern sc_card_driver_t* sc_get_openpgp_driver_8(void);
extern sc_card_driver_t* sc_get_openpgp_driver_9(void);
extern sc_card_driver_t* sc_get_openpgp_driver_a(void);
extern sc_card_driver_t* sc_get_openpgp_driver_b(void);
